...
public final class OpenLRDecoder implements openlr.OpenLRDecoder {
	...
	// VERSION information
	// please set the corresponding values after each change
	// small changes should increment the patch version
	// medium changes should increment the minor version and reset the patch
	// version
	// large changes including i/o format changes should increment the major
	// version and reset
