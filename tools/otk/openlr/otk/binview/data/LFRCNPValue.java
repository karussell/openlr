...
public class LFRCNPValue {
	 ...
	 * 
	 * @param lfrcnpValue the frc id
	 */
	public LFRCNPValue(final int lfrcnpValue) {
		lfrcnp = lfrcnpValue;
	}
	...
	public final String toString() {
		return Integer.toString(lfrcnp);
	}
	...
	public final String name() {
		if (lfrcnp >= 0 && lfrcnp < FunctionalRoadClass.getFRCs().size()) {
			return FunctionalRoadClass.getFRCs().get(lfrcnp).name();
		} else {
			return null;
		}
	}
