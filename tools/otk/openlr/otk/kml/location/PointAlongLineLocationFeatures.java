...
/**
 * A content provider that delivers the KML features for drawing a point along
 * the line location.
 * <p>
 ...
 */
class PointAlongLineLocationFeatures extends
        AbstractPointLocationFeatures<PointAlongLocation> {
     ...
     *            The object to draw
     */
    public PointAlongLineLocationFeatures(final PointAlongLocation location) {
        super(location);
